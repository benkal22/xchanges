# Generated by Django 5.0.6 on 2024-06-22 13:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Producer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='user_producer', serialize=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('product', models.ManyToManyField(blank=True, related_name='producers', to='inventory.product')),
                ('province', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='producer_province', to='inventory.province')),
            ],
        ),
        migrations.CreateModel(
            name='CompanyClient',
        ...
        migrations.AddField(
            ...
            name='producer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='producer_personal_client', to='inventory.producer'),
        ),
    ]
